...
signal did_combo_action(combo_action: ComboActionEntry)
...
@onready var control_fsm: FiniteStateMachine = $ControlFSM
...
func _did_combo_action(combo_action: ComboActionEntry):
	did_combo_action.emit(combo_action)
...
func get_debug_info() -> String:
	var debug_info_dictionary := {
		"current_state": control_fsm.active_state.name.to_pascal_case(),
